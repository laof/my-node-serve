...
exports.create = (router) => {
    router.post('/outlogin',require('./api/outlogin.api'));

    
    router.post('/outlogin',require('./api/outlogin.api'));
    router.post('/index',require('./api/index'));
    router.post('/login',require('./api/login.api'));
    router.post('/userInfo',require('./api/outlogin.api'));
    router.post('/user/login',require('./api/outlogin.api'));
    router.post('/weather/forecast',require('./api/outlogin.api'));
    router.post('/*',require('./api/outlogin.api'));
    // router.post('/------',require('./api/outlogin.api'));
    // router.post('/------',require('./api/outlogin.api'));`
